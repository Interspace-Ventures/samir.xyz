...
export default function MetricCard({ label, value, index = 0 }: MetricCardProps) {
  return (
    <motion.div 
      ...
      className="bg-gradient-to-br from-purple-500 to-purple-700 p-4 neobrutalist-shadow hover:neobrutalist-shadow-hover hover:neobrutalist-transform-hover transition-all duration-200 min-h-[80px] flex flex-col justify-center"
    >
